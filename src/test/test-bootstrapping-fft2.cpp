...
//四组,生成秘钥
  //  LweBootstrappingKeyFFT* bk[8];
    LweBootstrappingKeyFFT* bk = new_LweBootstrappingKeyFFT(params_in, params_bk);
 //   LweBootstrappingKeyFFT* bk2 = new_LweBootstrappingKeyFFT(params_in, params_bk);
  //  LweBootstrappingKeyFFT* bk3 = new_LweBootstrappingKeyFFT(params_in, params_bk);
  //  LweBootstrappingKeyFFT* bk4 = new_LweBootstrappingKeyFFT(params_in, params_bk);
...
//密钥生成完成
	...
	//主程序--tgswfunciton.h--tlwefftoperations.cpp
